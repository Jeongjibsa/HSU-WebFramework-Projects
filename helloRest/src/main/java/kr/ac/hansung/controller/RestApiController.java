...
public class RestApiController {
	...
	@GetMapping(value = "/users") // http://localhost:8080/helloRest
	...
	@GetMapping(value = "/users/{id}") // http://localhost:8080/helloRest
	public ResponseEntity<User> getUser(@PathVariable("id") long id) { // status, headers, body
